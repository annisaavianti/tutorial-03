...
public class MovieController {
	...
	public String add(@RequestParam(value = "id", required = true) String id, 
			@RequestParam(value = "title", required = true) String title, 			@RequestParam(value = "genre", required = true) String genre, 
	...
	@RequestMapping(value= {"/movie/update/{id}/duration/{upDuration}"})
	public String update(@PathVariable String id, @PathVariable Integer upDuration, Model model) {
		MovieModel archive = movieService.getMovieDetail(id);
		if (archive != null) {
			movieService.updateMovie(id, upDuration);
			return "update";
		} else {
			return "error";
		} 
